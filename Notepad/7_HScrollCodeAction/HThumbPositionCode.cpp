...
HThumbPositionCode::HThumbPositionCode(NotePadForm* notePadForm):HScrollCodeAction(notePadForm) {

}

HThumbPositionCode::~HThumbPositionCode() {

}

void HThumbPositionCode::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) {
